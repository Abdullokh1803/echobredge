  ...
  return (
    <section id={id} className="mt-20">
      ...
      <div className="bg-img bg-cover bg-center w-full h-[90vh] relative max-[450px]:h-[80vh]">
        <div
          data-aos="fade-up"
          className="w-36 gap-4 max-[450px]:gap-3 flex flex-col items-center text-center absolute top-[90px] left-[340px] max-[450px]:top-[120px] max-[450px]:left-0"
        >
        ...
        <div
          data-aos="fade-up"
          className="w-50 max-[450px]:w-45 gap-4 max-[450px]:gap-3 flex flex-col items-center text-center absolute top-[80px] left-[790px] max-[450px]:top-[100px] max-[450px]:left-[130px]"
        >
        ...
        <div
          data-aos="fade-up"
          className="w-50 max-[450px]:w-45 gap-4 max-[450px]:gap-3 flex flex-col items-center text-center absolute top-[200px] left-[1130px] max-[450px]:top-[50px] max-[450px]:left-[250px]"
        >
        ...
        <div
          data-aos="fade-up"
          className="w-40 gap-4 max-[450px]:gap-3 flex flex-col items-center text-center absolute top-[480px] left-[1090px] max-[450px]:top-[340px] max-[450px]:left-[250px]"
        >
